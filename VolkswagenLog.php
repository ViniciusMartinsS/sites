...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
       ...
       $preco = $row["preco"];
       echo "<a href='DetalhesAnuncio.php?id=". $row["id_veiculo"] ."' ><img class='centro' src='".$row["imagem"]."' width='300' height='200' > &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;";
       $img = $row["imagem"];
    }
} else {
